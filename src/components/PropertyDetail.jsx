...
export default function PropertyDetail({ id, onBack }) {
  ...
  const message = `Hola! Me interesa la propiedad en ${opText}: "${property.title}" ubicada en ${property.location} (${property.currency} ${Number(property.price).toLocaleString("es-AR")}). Mi consulta es la Gifts de la web:`;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="mt-4 lg:mt-0">
            <span style={{ fontFamily: "Inter, sans-serif", color: COLORS.muted }} className="text-[0.6rem] tracking-[0.3em] uppercase block mb-2">
              {opText} — {property.age_status === "CONSTRUCTION" ? "En Construcción" : property.age_status === "NEW" ? "A Estrenar" : `Usado — ${property.age_years} años`}
            </span>
            <h1 style={{ fontFamily: "Cormorant Garamond, serif", color: COLORS.text }} className="text-2xl sm:text-4xl md:text-5xl font-light mb-2 leading-tight">
            ...
            <div style={{ fontFamily: "Cormorant Garamond, serif" }} className="text-xl sm:text-2xl md:text-3xl font-medium mb-6 border-b border-white/10 pb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <motion.a
                ...
                className="w-full sm:w-2/3 border py-4 flex items-center justify-center gap-3 text-[0.65rem] tracking-[0.2em] uppercase transition-colors duration-300"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                style={{ fontFamily: "Inter, sans-serif", backgroundColor: "transparent", borderColor: "rgba(255,255,255,0.2)", color: "#FFFFFF" }}
                className="w-full sm:w-1/3 border py-4 flex items-center justify-center gap-3 text-[0.65rem] tracking-[0.2em] uppercase transition-colors duration-300"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="mb-8">
              <h2 style={{ fontFamily: "Inter, sans-serif", color: COLORS.muted }} className="text-[0.65rem] tracking-[0.2em] uppercase mb-3">Descripción</h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-8 text-sm font-light border-t border-white/5 pt-4">
                {[
