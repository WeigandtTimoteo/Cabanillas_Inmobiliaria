    ...
    <section style={{ backgroundColor: COLORS.bg }} className="min-h-screen py-32 px-6 md:px-16 w-full text-white">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 300, color: COLORS.text }} className="leading-tight">
            Ofrecé tu propiedad
          </h1>
          <p style={{ fontFamily: "Inter, sans-serif" }} className="text-sm font-light text-neutral-400 mt-4 max-w-xl leading-relaxed">
        ...
        <form className="flex flex-col gap-8 border-t border-white/5 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-2">
              <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", color: COLORS.muted }} className="uppercase">Nombre completo</label>
              <input
                type="text"
                placeholder="Ej: Sofía Cabanillas"
                value={form.nombre}
                onChange={(e) => setForm({ ...form, nombre: e.target.value })}
                className="border-b border-white/20 bg-transparent py-3 focus:outline-none focus:border-white transition-colors rounded-none text-white font-light text-sm"
              />
            </div>
            <div className="flex flex-col gap-2">
              <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", color: COLORS.muted }} className="uppercase">Teléfono / Email de contacto</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-2">
              <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", color: COLORS.muted }} className="uppercase">Tipo de propiedad</label>
              <select
                value={form.tipo}
                onChange={(e) => setForm({ ...form, tipo: e.target.value })}
                style={{ backgroundColor: COLORS.bg }}
                className="border-b border-white/20 bg-transparent py-3.5 focus:outline-none focus:border-white transition-colors rounded-none text-white font-light text-sm cursor-pointer"
              >
            ...
            <div className="flex flex-col gap-2">
              <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", color: COLORS.muted }} className="uppercase">Operación deseada</label>
              <select
          ...
          <div className="flex flex-col gap-2">
            <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", color: COLORS.muted }} className="uppercase">Ubicación / Barrio</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-2">
            <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.6rem", letterSpacing: "0.2em", color: COLORS.muted }} className="uppercase">Características y metros (Opcional)</label>
            <textarea
              rows={4}
              ...
              className="border-b border-white/20 bg-transparent py-3 focus:outline-none focus:border-white transition-colors resize-none rounded-none text-white font-light text-sm"
            />
          </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 w-full">
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className={`flex-1 py-4 text-[0.65rem] tracking-[0.2em] uppercase font-medium flex items-center justify-center gap-2 border transition-colors ${
