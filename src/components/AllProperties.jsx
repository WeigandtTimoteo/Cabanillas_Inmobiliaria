    ...
    <section style={{ backgroundColor: COLORS.bg }} className="min-h-screen py-24 md:py-32 px-4 sm:px-8 md:px-16 w-full text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(2.8rem, 5.5vw, 4.8rem)", fontWeight: 600, color: COLORS.text }} className="leading-none">
        ...
        <div className="mb-16 flex flex-col gap-8 border-b border-white/5 pb-10">
          ...
          <div className="w-full relative">
            <input
              ...
              className="w-full bg-transparent border-b py-3.5 px-1 focus:outline-none focus:border-white transition-colors text-base font-light rounded-none"
            />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 items-start w-full">
            ...
            <div className="flex flex-col gap-2.5 w-full">
              <label style={{ fontFamily: "Inter, sans-serif", fontSize: "0.78rem", letterSpacing: "0.15em", color: COLORS.muted }} className="uppercase">
                Operación
              </label>
              <select
                name="operation_type"
                ...
                className="bg-black text-white border px-4 py-2.5 text-sm font-light tracking-wider uppercase focus:outline-none focus:border-white rounded-none cursor-pointer h-11 w-full"
              >
            ...
            <div className="flex flex-col gap-2.5 w-full lg:col-span-2">
              ...
              <div className="flex gap-3 w-full">
                <input
                  ...
                  onChange={handleFilterChange}
                  style={{ fontFamily: "Inter, sans-serif", borderColor: "rgba(255,255,255,0.1)" }}
                  className="bg-black border text-white text-sm font-light px-4 py-2 w-full focus:outline-none focus:border-white rounded-none h-11 text-center"
                />
                <input
                  type="number"
                  name="max_price"
        ...
        {properties.length === 0 ? (
          <div className="py-24 text-center border border-white/5 bg-neutral-950/20">
            <p style={{ fontFamily: "Inter, sans-serif" }} className="text-base font-light opacity-40 tracking-widest uppercase">
            ...
            {properties.map((prop) => (
              ...
              >
                <div className="relative w-full mb-5 overflow-hidden border border-white/5" style={{ aspectRatio: "4/3" }}>
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-white text-black px-3 py-1 font-mono font-bold text-xs tracking-wider z-10">
                ...
                <div>
                  <h3 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "1.55rem", fontWeight: 600, color: COLORS.text }} className="mb-1 truncate">
                  ...
                  <div className="flex items-center justify-between border-t border-white/10 pt-4">
                    <span style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "1.35rem", fontWeight: 600, color: COLORS.text }}>
